...
public class ReporteStockMinimoFrame extends JFrame {

    private JTable tablaStockMinimo;
    private DefaultTableModel modeloTabla;

    public ReporteStockMinimoFrame() {
        setTitle("Reporte: Medicamentos próximos a caducar (30 días)");
        setSize(800, 400);
        ...
        tablaStockMinimo = new JTable(modeloTabla);

        JScrollPane scrollPane = new JScrollPane(tablaStockMinimo);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ReporteStockMinimoFrame().setVisible(true));
    }
}
