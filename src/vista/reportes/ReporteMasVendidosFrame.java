...
public class ReporteMasVendidosFrame extends JFrame {

    private JTable tablaMasVendidos;
    private DefaultTableModel modeloTabla;

    public ReporteMasVendidosFrame() {
        ...
        tablaMasVendidos = new JTable(modeloTabla);

        JScrollPane scrollPane = new JScrollPane(tablaMasVendidos);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ReporteMasVendidosFrame().setVisible(true));
    }
}
