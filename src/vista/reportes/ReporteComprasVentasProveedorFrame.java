...
public class ReporteComprasVentasProveedorFrame extends JFrame {

    private JTable tablaReporte;
    private DefaultTableModel modeloTabla;

    public ReporteComprasVentasProveedorFrame() {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ReporteComprasVentasProveedorFrame().setVisible(true));
    }
}
